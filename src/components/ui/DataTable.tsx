              ...
              <thead>
                <tr className="border-b border-gray-100">
                  {columns.map((col, i) => (
                    <th
                      key={i}
                      className={`px-5 py-3 ${getAlignClass(col.align)} text-[11px] font-semibold text-gray-400 uppercase tracking-wider${col.sticky ? ' sticky right-0 bg-gray-50 z-10' : ''}`}
                ...
                {data.map((item, index) => (
                  ...
                  >
                    {columns.map((col, colIndex) => (
                      <td
                        key={colIndex}
                        className={`px-5 py-3.5${col.sticky ? ' sticky right-0 bg-white group-hover:bg-gray-50/80 z-10' : ''}`}
                      >
