              ...
              <thead>
                <tr className="border-b border-gray-100">
                  {columns.map((col, i) => (
                    <th
                      key={i}
                      className={`px-5 py-3 ${getAlignClass(col.align)} text-[11px] font-semibold text-gray-400 uppercase tracking-wider${col.sticky ? ' sticky right-0 bg-gray-100 z-10 shadow-[-2px_0_4px_rgba(0,0,0,0.04)]' : ''}`}
                ...
                {data.map((item, index) => (
                  ...
                  >
                    {columns.map((col, colIndex) => (
                      <td
                        key={colIndex}
                        className={`px-5 py-3.5${col.sticky ? ' sticky right-0 bg-gray-50 group-hover:bg-gray-100/80 z-10 shadow-[-2px_0_4px_rgba(0,0,0,0.04)]' : ''}`}
                      >
