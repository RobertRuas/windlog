...
export enum LogAction {
  ...
  // E-mail (cliente integrado)
  EMAIL_ACCOUNT_CONNECT = 'EMAIL_ACCOUNT_CONNECT',
  EMAIL_ACCOUNT_UPDATE = 'EMAIL_ACCOUNT_UPDATE',
  EMAIL_ACCOUNT_DISCONNECT = 'EMAIL_ACCOUNT_DISCONNECT',
  EMAIL_SYNC = 'EMAIL_SYNC',
  EMAIL_SEND = 'EMAIL_SEND',
  EMAIL_READ = 'EMAIL_READ',
  EMAIL_MOVE = 'EMAIL_MOVE',
  EMAIL_DELETE = 'EMAIL_DELETE',
  EMAIL_FOLDER_CREATE = 'EMAIL_FOLDER_CREATE',
  EMAIL_FOLDER_UPDATE = 'EMAIL_FOLDER_UPDATE',
  EMAIL_FOLDER_DELETE = 'EMAIL_FOLDER_DELETE',
  EMAIL_RULE_CREATE = 'EMAIL_RULE_CREATE',
  EMAIL_RULE_UPDATE = 'EMAIL_RULE_UPDATE',
  EMAIL_RULE_DELETE = 'EMAIL_RULE_DELETE',
  EMAIL_CONTACT_CREATE = 'EMAIL_CONTACT_CREATE',
  EMAIL_CONTACT_DELETE = 'EMAIL_CONTACT_DELETE',
